...
Rate-limit exhaustion exits 4.`,
  ...
  key_settings_model_prev: "change model",
  key_settings_model_next: "change model",
  ...
  // T035: Tasks リスト r キー昇格
  key_task_promote_ready: "Promote to ready",
  toast_promote_label_success: "Promoted",
  toast_promote_label_failed: "Promote failed",
  toast_promote_not_draft: "T{id} is {status} (draft only)",
  toast_promote_conflict: "T{id} state changed; promotion skipped",
...
レート制限到達は exit 4 で終了します。`,
  ...
  key_settings_model_prev: "モデル変更",
  key_settings_model_next: "モデル変更",
  ...
  // T035: Tasks リスト r キー昇格
  key_task_promote_ready: "ready に昇格",
  toast_promote_label_success: "ready 昇格",
  toast_promote_label_failed: "昇格失敗",
  toast_promote_not_draft: "T{id} は {status}（draft のみ昇格可）",
  toast_promote_conflict: "T{id} の状態が変化したため昇格を中止",
  chord_pending_indicator: "c-",
  key_issues_sync: "同期",
