...
すべての作業は git worktree `/Users/yamamoto/git/elevens/.worktrees/task-014-1779211698` 内で行う。
```bash
cd /Users/yamamoto/git/elevens/.worktrees/task-014-1779211698
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-014-1779211698/task`
...
```
/Users/yamamoto/git/elevens/.team/tasks/014-manager-conductor-asking-askquestion/runs/task-014-1779211698
```

結果サマリーは `/Users/yamamoto/git/elevens/.team/tasks/014-manager-conductor-asking-askquestion/runs/task-014-1779211698/summary.md` に書き出す。
