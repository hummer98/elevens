...
すべての作業は git worktree `/Users/yamamoto/git/elevens/.worktrees/task-008-1778577016` 内で行う。
```bash
cd /Users/yamamoto/git/elevens/.worktrees/task-008-1778577016
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-008-1778577016/task`
...
```
/Users/yamamoto/git/elevens/.team/tasks/008-abort-broken-kill-reserved/runs/task-008-1778577016
```

結果サマリーは `/Users/yamamoto/git/elevens/.team/tasks/008-abort-broken-kill-reserved/runs/task-008-1778577016/summary.md` に書き出す。
