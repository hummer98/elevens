...
---
id: 021
title: surface 不在の残骸 Conductor を team.json から除去できる経路を追加
priority: medium
created_by: surface:29
created_at: 2026-05-23T22:09:28.501Z
---
...
すべての作業は git worktree `/Users/yamamoto/git/elevens/.worktrees/task-021-1779574168` 内で行う。
```bash
cd /Users/yamamoto/git/elevens/.worktrees/task-021-1779574168
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-021-1779574168/task`
...
```
/Users/yamamoto/git/elevens/.team/tasks/021-surface-conductor-team-json/runs/task-021-1779574168
```

結果サマリーは `/Users/yamamoto/git/elevens/.team/tasks/021-surface-conductor-team-json/runs/task-021-1779574168/summary.md` に書き出す。
