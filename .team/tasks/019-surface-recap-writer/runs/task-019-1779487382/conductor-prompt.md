...
---
id: 019
title: surface タブタイトルが recap で上書きされる問題の writer 特定と修正
priority: high
created_by: surface:29
created_at: 2026-05-22T20:57:58.937Z
---
...
すべての作業は git worktree `/Users/yamamoto/git/elevens/.worktrees/task-019-1779487382` 内で行う。
```bash
cd /Users/yamamoto/git/elevens/.worktrees/task-019-1779487382
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-019-1779487382/task`
...
```
/Users/yamamoto/git/elevens/.team/tasks/019-surface-recap-writer/runs/task-019-1779487382
```

結果サマリーは `/Users/yamamoto/git/elevens/.team/tasks/019-surface-recap-writer/runs/task-019-1779487382/summary.md` に書き出す。
