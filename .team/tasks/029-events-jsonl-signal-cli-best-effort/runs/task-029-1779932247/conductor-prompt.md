...
すべての作業は git worktree `/Users/yamamoto/git/elevens/.worktrees/task-029-1779932247` 内で行う。
```bash
cd /Users/yamamoto/git/elevens/.worktrees/task-029-1779932247
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-029-1779932247/task`
...
```
/Users/yamamoto/git/elevens/.team/tasks/029-events-jsonl-signal-cli-best-effort/runs/task-029-1779932247
```

結果サマリーは `/Users/yamamoto/git/elevens/.team/tasks/029-events-jsonl-signal-cli-best-effort/runs/task-029-1779932247/summary.md` に書き出す。
