...
すべての作業は git worktree `/Users/yamamoto/git/elevens/.worktrees/task-011-1779141147` 内で行う。
```bash
cd /Users/yamamoto/git/elevens/.worktrees/task-011-1779141147
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-011-1779141147/task`
...
```
/Users/yamamoto/git/elevens/.team/tasks/011-worktree-archive-destructive-cleanup/runs/task-011-1779141147
```

結果サマリーは `/Users/yamamoto/git/elevens/.team/tasks/011-worktree-archive-destructive-cleanup/runs/task-011-1779141147/summary.md` に書き出す。
