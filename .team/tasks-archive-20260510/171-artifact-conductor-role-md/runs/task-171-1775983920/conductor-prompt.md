...
cmux-team artifacts add /Users/yamamoto/git/cmux-team/.team/tasks/171-artifact-conductor-role-md/runs/task-171-1775983920/summary.md \
  --type research \
  --title "<タスク概要を1行で>"
\`\`\`
...
- `/Users/yamamoto/git/cmux-team`, `/Users/yamamoto/git/cmux-team/.team/tasks/171-artifact-conductor-role-md/runs/task-171-1775983920` はテンプレート変数（CLAUDE.md のテンプレート変数仕様参照）
...
すべての作業は git worktree `/Users/yamamoto/git/cmux-team/.worktrees/task-171-1775983920` 内で行う。
```bash
cd /Users/yamamoto/git/cmux-team/.worktrees/task-171-1775983920
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-171-1775983920/task`
...
```
/Users/yamamoto/git/cmux-team/.team/tasks/171-artifact-conductor-role-md/runs/task-171-1775983920
```

結果サマリーは `/Users/yamamoto/git/cmux-team/.team/tasks/171-artifact-conductor-role-md/runs/task-171-1775983920/summary.md` に書き出す。
