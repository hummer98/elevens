...
run_after_all: true
exclusive: true
created_at: 2026-04-26T12:38:37.047Z
---
...
すべての作業は git worktree `/Users/yamamoto/git/cmux-team/.worktrees/task-348-1777207117` 内で行う。
```bash
cd /Users/yamamoto/git/cmux-team/.worktrees/task-348-1777207117
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-348-1777207117/task`
...
```
/Users/yamamoto/git/cmux-team/.team/tasks/348-task/runs/task-348-1777207117
```

結果サマリーは `/Users/yamamoto/git/cmux-team/.team/tasks/348-task/runs/task-348-1777207117/summary.md` に書き出す。
