...
priority: high
run_after_all: true
created_at: 2026-04-17T02:27:09.521Z
---
...
すべての作業は git worktree `/Users/yamamoto/git/cmux-team/.worktrees/task-237-1776393762` 内で行う。
```bash
cd /Users/yamamoto/git/cmux-team/.worktrees/task-237-1776393762
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-237-1776393762/task`
...
```
/Users/yamamoto/git/cmux-team/.team/tasks/237-task/runs/task-237-1776393762
```

結果サマリーは `/Users/yamamoto/git/cmux-team/.team/tasks/237-task/runs/task-237-1776393762/summary.md` に書き出す。
