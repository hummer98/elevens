...
run_after_all: true
exclusive: true
created_by: surface:180
created_at: 2026-04-27T03:45:50.198Z
---
...
すべての作業は git worktree `/Users/yamamoto/git/cmux-team/.worktrees/task-365-1777261625` 内で行う。
```bash
cd /Users/yamamoto/git/cmux-team/.worktrees/task-365-1777261625
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-365-1777261625/task`
...
```
/Users/yamamoto/git/cmux-team/.team/tasks/365-task/runs/task-365-1777261625
```

結果サマリーは `/Users/yamamoto/git/cmux-team/.team/tasks/365-task/runs/task-365-1777261625/summary.md` に書き出す。
