...
priority: high
run_after_all: true
created_at: 2026-04-13T16:31:25.148Z
---
...
すべての作業は git worktree `/Users/yamamoto/git/cmux-team/.worktrees/task-179-1776097885` 内で行う。
```bash
cd /Users/yamamoto/git/cmux-team/.worktrees/task-179-1776097885
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-179-1776097885/task`
...
```
/Users/yamamoto/git/cmux-team/.team/tasks/179-task/runs/task-179-1776097885
```

結果サマリーは `/Users/yamamoto/git/cmux-team/.team/tasks/179-task/runs/task-179-1776097885/summary.md` に書き出す。
