...
priority: high
run_after_all: true
created_at: 2026-04-15T02:06:30.656Z
---
...
すべての作業は git worktree `/Users/yamamoto/git/cmux-team/.worktrees/task-202-1776218790` 内で行う。
```bash
cd /Users/yamamoto/git/cmux-team/.worktrees/task-202-1776218790
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-202-1776218790/task`
...
```
/Users/yamamoto/git/cmux-team/.team/tasks/202-task/runs/task-202-1776218790
```

結果サマリーは `/Users/yamamoto/git/cmux-team/.team/tasks/202-task/runs/task-202-1776218790/summary.md` に書き出す。
