...
すべての作業は git worktree `/Users/yamamoto/git/cmux-team/.worktrees/task-390-1777531936` 内で行う。
```bash
cd /Users/yamamoto/git/cmux-team/.worktrees/task-390-1777531936
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-390-1777531936/task`
...
```
/Users/yamamoto/git/cmux-team/.team/tasks/390-pool-status-token-list-per-handle-effutil-stale/runs/task-390-1777531936
```

結果サマリーは `/Users/yamamoto/git/cmux-team/.team/tasks/390-pool-status-token-list-per-handle-effutil-stale/runs/task-390-1777531936/summary.md` に書き出す。
