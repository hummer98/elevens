...
1. **Step 8 と Step 9 の基準が非対称**
   - Step 8: `origin/main` に rebase
   - Step 9: **local** `main` に ff-only merge
...
すべての作業は git worktree `/Users/yamamoto/git/cmux-team/.worktrees/task-268-1776579825` 内で行う。
```bash
cd /Users/yamamoto/git/cmux-team/.worktrees/task-268-1776579825
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-268-1776579825/task`
...
```
/Users/yamamoto/git/cmux-team/.team/tasks/268-conductor-step-8-9-conflict/runs/task-268-1776579825
```

結果サマリーは `/Users/yamamoto/git/cmux-team/.team/tasks/268-conductor-step-8-9-conflict/runs/task-268-1776579825/summary.md` に書き出す。
