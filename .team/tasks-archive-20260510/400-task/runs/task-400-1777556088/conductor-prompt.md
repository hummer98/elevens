...
created_at: 2026-04-30T13:34:48.878Z
---
...
> **NOTE**: 本来は --exclusive で起票したいが、現行 daemon が T397 fix 取り込み前で run_after_all 系が deadlock する状態のため、暫定で並走許容（exclusive なし）で起票している。release 完了後 daemon が再起動されれば次回以降は --exclusive で問題ない。
...
すべての作業は git worktree `/Users/yamamoto/git/cmux-team/.worktrees/task-400-1777556088` 内で行う。
```bash
cd /Users/yamamoto/git/cmux-team/.worktrees/task-400-1777556088
```
main ブランチに直接変更を加えてはならない。

ブランチ名: `task-400-1777556088/task`
...
```
/Users/yamamoto/git/cmux-team/.team/tasks/400-task/runs/task-400-1777556088
```

結果サマリーは `/Users/yamamoto/git/cmux-team/.team/tasks/400-task/runs/task-400-1777556088/summary.md` に書き出す。
